...
dnadiff from the [mummer](https://mummer4.github.io/index.html) package compares each assembly to the reference genomes and calculates an average identity and the number of indels.
...
[NucDiff](https://github.com/uio-cels/NucDiff/) compares each assembly to the reference genomes and calculates the number of insertions, deletions, and substitutions.
