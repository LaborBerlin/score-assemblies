...
df.ideel_uniprot %>% 
 DT::datatable(escape = FALSE, rownames = FALSE, class="compact hover", extensions = 'FixedHeader',
  							options = list(pageLength = 10, searchHighlight = TRUE, paginate = TRUE, lengthChange = FALSE, fixedHeader = TRUE)) %>%
...
df.ideel_ref %>% 
 DT::datatable(escape = FALSE, rownames = FALSE, class="compact hover", extensions = 'FixedHeader',
  							options = list(pageLength = 10, searchHighlight = TRUE, paginate = TRUE, lengthChange = FALSE, fixedHeader = TRUE, order = list(list(2, 'desc')))) %>%
